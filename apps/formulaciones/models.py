...
class Formulacion(models.Model):
    class Categoria(models.TextChoices):
        ...
        MAGISTRAL_TIPIFICADA = "MAGISTRAL_TIPIFICADA", "Formula magistral tipificada"
        PREPARADO_OFICIAL = "PREPARADO_OFICIAL", "Preparado oficial"
    ...
    categoria = models.CharField(max_length=30, choices=Categoria.choices, default=Categoria.MAGISTRAL_TIPIFICADA)
    ...
    fuente_referencia = models.CharField(max_length=100, blank=True)
